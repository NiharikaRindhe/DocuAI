...
# # Set API Key (Backend Only)
# API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyCfyvK6MhIyr4Dc0BrJg3T2C1N05EB1Wy0")  # Use env variable or replace with your API key
...
#     if not API_KEY:
#         st.error("❌ API Key is missing. Set it in the backend.")
#         return
